...
public class GroupByMonth extends GroupBy {
	GroupByMonth(String aName) {
		//protected
		super(aName);
	}
	...
	public int compare(Task t1, Task t2) {
		...
		if (tempCal1.get(Calendar.MONTH) == tempCal2
				.get(Calendar.MONTH)
				&& tempCal1.get(Calendar.YEAR) == tempCal2
						.get(Calendar.YEAR)) {
			return 0;
		}
	...
	private DateFormat DATE_FORMAT = new SimpleDateFormat("MM.yyyy");
